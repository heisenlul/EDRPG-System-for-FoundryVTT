...
export const rangedWeapons = [
   {
      ...
      ammo: "3",
      price: 4,
      notes: "One Handed, Burst (2D10)",
      rangeShort: { distance: 6, modifier: 5 },
      rangeMedium: { distance: 50, modifier: 8 },
      rangeLong: { distance: 100, modifier: 14 },
   },

   {
      name: "NG75 Autopistol",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "1D10 + Burst",
...

   {
      ...
      ammo: "6",
      price: 50000,
      notes: "One Handed, Burst (2D10), +5 to Kinetic Weapons score",
      rangeShort: { distance: 6, modifier: 5 },
      rangeMedium: { distance: 50, modifier: 8 },
      rangeLong: { distance: 100, modifier: 14 },
   },
   ...
   {
      name: "Sentinel Gold & Perry 'Watcher' Autopistol",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "1D10 + Burst",
      ...
      price: 65000,
      notes: "One Handed, Burst (2D10)",
      rangeShort: { distance: 10, modifier: 5 },
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
   },

   {
      name: "GTN 195 Autopistol",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "2D10 + Burst",
      ...
      price: 225000,
      notes: "One Handed, Burst (2D10)",
      rangeShort: { distance: 8, modifier: 5 },
      rangeMedium: { distance: 56, modifier: 8 },
      rangeLong: { distance: 110, modifier: 14 },
   },

   {
      name: "Imperial 'Stimmer' Autopistol",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "1D10 + Burst",
      ammo: "3",
      price: 400500,
      notes: "One Handed, Burst (2D10), +5 to Kinetic Weapons score, Injects Combat Stims (80%) on 0 Endurance.",
      rangeShort: { distance: 6, modifier: 5 },
      rangeMedium: { distance: 50, modifier: 8 },
      rangeLong: { distance: 100, modifier: 14 },
   },

   {
      ...
      ammo: "3",
      price: 1005000,
      notes: "One Handed, Burst (2D10), +10 to Kinetic Weapons score, Absorb 3 Kinetic and Energy damage.",
      rangeShort: { distance: 6, modifier: 5 },
      rangeMedium: { distance: 50, modifier: 8 },
      rangeLong: { distance: 100, modifier: 14 },
   },
   ...
   {
      name: "LX10 Energised Autopistol",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "2D10 + Burst",
      ammo: "4",
      price: 1400000,
      notes: "One Handed, Burst (2D10), +5 to Kinetic Weapons score, damage counts as Energy Weapon",
      rangeShort: { distance: 6, modifier: 5 },
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
   },
   ...
   {
      name: "Corvus Inc Devastation Pistol",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "1D10 + Burst",
      ammo: "4",
      price: 2900000,
      notes: "One Handed, Burst (4D10), +15 to Kinetic Weapons score",
      rangeShort: { distance: 10, modifier: 5 },
      rangeMedium: { distance: 56, modifier: 8 },
      rangeLong: { distance: 110, modifier: 14 },
   },

   {
      ...
      ammo: "2",
      price: 5000000,
      notes: "One Handed, Burst (2D10), +20 to Kinetic Weapons score",
      rangeShort: { distance: 10, modifier: 5 },
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
   },
...

   {
      ...
      ammo: "10",
      price: 83000,
      notes: "One Handed, +10 to Kinetic Weapons score, Social Factor +1",
      rangeShort: { distance: 8, modifier: 5 },
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 110, modifier: 14 },
   },
   ...
   {
      name: "Callaghan Arctic Hawk Heavy Pistol",
      source: "Espionage",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "3D10",
   ...
   {
      name: "Thordarson Firepoint Scoped Pistol",
      source: "Espionage",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "2D10",
      ammo: "8",
      price: 305000,
      notes: "One Handed, +20 to Kinetic Weapons score",
      rangeShort: { distance: 10, modifier: 5 },
      rangeMedium: { distance: 70, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
   },

   {
      name: "Leonis Hacker Pistol",
      source: "Espionage",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "2D10",
      ammo: "8",
      price: 695000,
      notes: "One Handed, +10 to Kinetic Weapons, Computer and Security score",
      rangeShort: { distance: 8, modifier: 5 },
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 110, modifier: 14 },
   },
      ...
      damage: "8",
      ammo: "N/A",
      rangeShort: { distance: 10, modifier: 4 },
      rangeMedium: { distance: 80, modifier: 7 },
      rangeLong: { distance: 120, modifier: 11 },
      notes: "One Handed",
   },

   {
      name: "Hyperion Laser Pistol",
      category: "weapon",
      source: "Core",
      price: 47000,
      weaponType: "Energy",
      ...
      ammo: "N/A",
      rangeShort: { distance: 10, modifier: 4 },
      rangeMedium: { distance: 100, modifier: 7 },
      rangeLong: { distance: 150, modifier: 11 },
      notes: "One Handed, +5 to Energy Weapons score",
   },

   {
      name: "Evex Long-barrel Laser Pistol",
      category: "weapon",
      source: "Core",
      price: 98000,
      weaponType: "Energy",
      damage: "8",
      ammo: "N/A",
      rangeShort: { distance: 16, modifier: 4 },
      rangeMedium: { distance: 80, modifier: 7 },
      rangeLong: { distance: 120, modifier: 11 },
      notes: "One Handed",
   },
   ...
   {
      name: "Cauldus Nerve-blocker Laser Pistol",
      category: "weapon",
      source: "Core",
      price: 196000,
      weaponType: "Energy",
      ...
      rangeMedium: { distance: 80, modifier: 7 },
      rangeLong: { distance: 120, modifier: 11 },
      notes: "One Handed, knocks over target on a natural 9 or 10 To Hit, target disarmed if knocked over.",
   },

   {
      name: "CS1 Burst Pistol",
      category: "weapon",
      source: "Core",
      price: 244000,
      weaponType: "Energy",
      damage: "5 + Burst",
      ammo: "N/A",
      rangeShort: { distance: 8, modifier: 4 },
      rangeMedium: { distance: 60, modifier: 7 },
      rangeLong: { distance: 90, modifier: 11 },
      notes: "One Handed, Burst (max 15)",
   },

   {
      name: "Nadion Twin Barrel Laser Pistol",
      category: "weapon",
      source: "Core",
      price: 863000,
      weaponType: "Energy",
   ...
   {
      name: "Paris Eleganté Laser Pistol",
      category: "weapon",
      source: "Core",
      price: 1809000,
      weaponType: "Energy",
      ...
      rangeMedium: { distance: 80, modifier: 7 },
      rangeLong: { distance: 120, modifier: 11 },
      notes: "One Handed, +15 to Energy Weapon score.",
   },

   {
      name: "Magnetising Hotshot Laserpistol",
      category: "weapon",
      source: "Core",
      price: 3550000,
      weaponType: "Energy",
      damage: "12",
      ammo: "N/A",
      rangeShort: { distance: 12, modifier: 4 },
      rangeMedium: { distance: 90, modifier: 7 },
      rangeLong: { distance: 130, modifier: 11 },
      notes: "One Handed, +10 to Energy Weapons Score, +1 bonus To Hit if you have previously hit the target with this weapon.",
   },

   {
      name: "GL779 Intellipistol",
      category: "weapon",
      source: "Core",
      price: 8200000,
      weaponType: "Energy",
      ...
      rangeMedium: { distance: 90, modifier: 7 },
      rangeLong: { distance: 130, modifier: 11 },
      notes: "One Handed, Fires with Energy Weapons Skill Bonus of 9, ignores firer's Skill.",
   },
      {
      name: "Manticore Tormentor Plasma Pistol",
      category: "weapon",
      source: "Core",
      price: 2500000,
      weaponType: "Plasma",
      ...
      rangeShort: { distance: 6, modifier: 5 },
      rangeMedium: { distance: 50, modifier: 8 },
      rangeLong: { distance: 90, modifier: 14 },
      notes: "One Handed",
   },
      {
      name: "Sub Machinegun",
...

   {
      ...
      ammo: "2",
      rangeShort: { distance: 18, modifier: 0 },
      rangeMedium: { distance: 60, modifier: 9 },
      rangeLong: { distance: 150, modifier: 14 },
      notes: "Direct Fire Explosive. Blast Radius: Fatal 6m, Injury 16m. Minimum Safe Range 18m. Grenade cost 40cr.",
   },

   {
      ...
      damage: "1D10 + Burst",
      ammo: "8",
      rangeShort: { distance: 12, modifier: 5 },
      rangeMedium: { distance: 64, modifier: 8 },
      rangeLong: { distance: 128, modifier: 14 },
      notes: "Burst (3D10)",
   },

   {
      name: "K33 Multifire SMG",
      category: "weapon",
      source: "Core",
      price: 175500,
      weaponType: "Kinetic",
...

   {
      ...
      rangeMedium: { distance: 64, modifier: 8 },
      rangeLong: { distance: 128, modifier: 14 },
      notes: "Burst (3D10), +5 to Kinetic Weapons score. Includes underslung grenade launcher.",
   },

   {
      name: "Skollanga 'Slammer' SMG",
      category: "weapon",
      source: "Core",
      price: 985000,
      weaponType: "Kinetic",
      ...
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
      notes: "Burst (3D10). Target knocked over on a natural 9 or 10 To Hit.",
   },

   {
      ...
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
      notes: "Burst (4D10). +10 to Kinetic Weapons score.",
   },

   {
      name: "Krakoff Demolisher Rifle",
      category: "weapon",
      source: "Core",
      price: 3050000,
      weaponType: "Kinetic",
      ...
      rangeMedium: { distance: 60, modifier: 8 },
      rangeLong: { distance: 120, modifier: 14 },
      notes: "Burst (4D10). Includes underslung grenade launcher.",
   },
      {
      name: "Laser Carbine",
      category: "weapon",
      source: "Military DLC",
      price: 10,
      weaponType: "Energy/Kinetic",
      damage: "10 + Burst",
      ammo: "4",
      rangeShort: { distance: 16, modifier: 5 },
      rangeMedium: { distance: 100, modifier: 8 },
      rangeLong: { distance: 300, modifier: 9 },
      notes: "Burst (3D10). 50cr with underslung grenade launcher.",
   },

   {
      ...
      rangeMedium: { distance: 60, modifier: 9 },
      rangeLong: { distance: 150, modifier: 14 },
      notes: "Direct Fire. Explosive Blast Radius: Fatal 6m, Injury 16m. Minimum Safe Range 18m.",
   },

   {
      name: "Mannex Nighteye Carbine",
      category: "weapon",
      source: "Military DLC",
      price: 270000,
      weaponType: "Energy/Kinetic",
...

   {
      ...
      rangeMedium: { distance: 100, modifier: 8 },
      rangeLong: { distance: 300, modifier: 9 },
      notes: "Burst (3D10). Armour Piercing ignores Kinetic armour absorption.",
   },

   {
      name: "Krayton KX Heavy",
      category: "weapon",
      source: "Military DLC",
      price: 2200000,
      weaponType: "Energy/Kinetic",
      ...
      rangeMedium: { distance: 100, modifier: 8 },
      rangeLong: { distance: 300, modifier: 9 },
      notes: "Heavy Burst (8D10)",
   },
      {
      name: "Manticore Oppressor Assault Rifle",
      category: "weapon",
      source: "Evolution",
      price: 5000000,
      weaponType: "Kinetic",
      damage: "1D10 + 10",
      ammo: "5",
      rangeShort: { distance: 12, modifier: 6 },
      rangeMedium: { distance: 60, modifier: 7 },
      rangeLong: { distance: 320, modifier: 10 },
      notes: "Burst (3D10)",
   },
      {
      name: "Assault Beamer",
      ...
      ammo: "N/A",
      rangeShort: { distance: 12, modifier: 4 },
      rangeMedium: { distance: 70, modifier: 7 },
      rangeLong: { distance: 200, modifier: 10 },
      notes: "Burst (20). Destroy Cover. Divide Fire.",
   },

   {
      name: "Ingram Wide-Beam Carbine",
      category: "weapon",
      source: "Core",
      price: 62000,
      weaponType: "Energy",
      ...
      rangeShort: { distance: 10, modifier: 4 },
      rangeMedium: { distance: 60, modifier: 7 },
      rangeLong: { distance: 150, modifier: 10 },
      notes: "Burst (20). +5 to Energy Weapons score. Destroy Cover. Divide Fire.",
   },

   {
      name: "Laifan AB5 Serrator",
      category: "weapon",
      source: "Core",
      price: 2134000,
      weaponType: "Energy",
      ...
      rangeMedium: { distance: 70, modifier: 7 },
      rangeLong: { distance: 200, modifier: 10 },
      notes: "Burst (30). On a natural 1 To Hit the weapon inflicts 10 Energy damage on user. Destroy Cover. Divide Fire.",
   },

   {
      name: "Magnotan Searching Beamer",
      category: "weapon",
      source: "Core",
      price: 13599000,
      weaponType: "Energy",
      ...
      rangeMedium: { distance: 70, modifier: 7 },
      rangeLong: { distance: 200, modifier: 10 },
      notes: "Burst (20). +20 to Energy Weapons score. Destroy Cover. Divide Fire.",
   },
      {
      name: "XV2MX Plasma Lance",
      category: "weapon",
      source: "Evolution",
      price: 20000000,
      weaponType: "Plasma",
      damage: "200",
      ammo: "1",
      rangeShort: { distance: 500, modifier: 8 },
      rangeMedium: { distance: 3000, modifier: 10 },
      rangeLong: { distance: 3000, modifier: 10 },
      notes: "Anti Tank. Minimum Safe Range 36m. Firer knocked over unless weapon is tripod mounted.",
   },
      {
      name: "Exalt Widescatter Shotgun",
      source: "Core",
      category: "weapon",
      weaponType: "Shotgun",
      damage: "3D10*",
      ammo: 6,
      price: 5,
      notes: "*Damage is 2D10 at Medium Range, 1D10 at Long Range.",
      rangeShort: "6m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "50m (12)",
   },

   {
      ...
      ammo: 3,
      price: 78000,
      notes: "*Damage is 2D10 at Medium Range, 1D10 at Long Range. Divide Fire (special).",
      rangeShort: "6m (3)",
      rangeMedium: "10m (7)",
      rangeLong: "30m (12)",
   },

   {
      ...
      ammo: 6,
      price: 190000,
      notes: "One-handed. *Damage is 2D10 at Medium Range, 1D10 at Long Range.",
      rangeShort: "6m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "50m (12)",
   },
   {
      name: "Jupiter ‘Lockon’ Short Barrelled Rifle",
      source: "Core",
      category: "weapon",
      weaponType: "Shotgun",
      damage: "4D10*",
      ammo: 6,
      price: 209000,
      notes: "*Damage is 3D10 at Medium Range, 1D10 at Long Range. At short range knock over a target on a natural 8, 9 or 10 To Hit. Malfunctions on a natural 1.",
      rangeShort: "8m (3)",
      rangeMedium: "16m (7)",
      rangeLong: "70m (12)",
   },

   {
      ...
      ammo: 3,
      price: 867000,
      notes: "*Damage is 2D10 at Medium Range, 1D10 at Long Range. +10 Kinetic Skill score.",
      rangeShort: "6m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "50m (12)",
   },
   ...
   {
      name: "Manticore Intimidator Shotgun PLASMA",
      source: "Evolution",
      category: "weapon",
      weaponType: "Shotgun",
      damage: "4D10 + 10",
      ammo: 2,
      price: 5000000,
      notes: "3D10 + 10 at Medium Range; 1D10 + 10 at Long Range.",
      rangeShort: "6m (3)",
      rangeMedium: "10m (7)",
      rangeLong: "30m (12)",
   },
   {
      ...
      ammo: 4,
      price: 15,
      notes: "Burst (3D10). N/A (90cr with Underslung Grenade Launcher). Underslung Grenade Launcher: Direct Fire (Minimum Skill), Fatal: 25, Injury: 10, Blast Radius: Fatal 6m, Injury 16m, Safe Range 18m.",
      rangeShort: "16m (6)",
      rangeMedium: "100m (7)",
      rangeLong: "400m (10)",
   },

   {
      ...
      ammo: 4,
      price: 30000,
      notes: "Burst (3D10). +5 to Kinetic Weapons score.",
      rangeShort: "16m (6)",
      rangeMedium: "100m (7)",
      rangeLong: "400m (10)",
   },
   ...
   {
      name: "GalSpec 109 Sniper Rifle",
      source: "Core",
      category: "weapon",
      weaponType: "Kinetic",
      damage: "15 or 1D10 + Burst",
      ammo: 5,
      price: 101000,
      notes: "Burst (3D10). +15 Kinetic Weapons score in Sniper Mode.",
      rangeShort: "16m (6)",
      rangeMedium: "100m (7)",
      rangeLong: "800m (8)",
   },

   {
      ...
      ammo: 6,
      price: 495000,
      notes: "Burst (3D10). Includes underslung grenade launcher.",
      rangeShort: "16m (6)",
      rangeMedium: "100m (7)",
      rangeLong: "400m (10)",
   },

   {
      ...
      ammo: 4,
      price: 1788000,
      notes: "Burst (3D10). +10 Kinetic Weapons score. Includes underslung grenade launcher.",
      rangeShort: "18m (6)",
      rangeMedium: "140m (7)",
      rangeLong: "600m (10)",
   },
...

   {
      ...
      ammo: "N/A",
      price: 49000,
      notes: "+5 to Energy Weapon score.",
      rangeShort: "20m (5)",
      rangeMedium: "150m (6)",
      rangeLong: "500m (9)",
   },
...

   {
      ...
      ammo: "N/A",
      price: 327500,
      notes: "+10 to Energy Weapons score.",
      rangeShort: "24m (5)",
      rangeMedium: "200m (6)",
      rangeLong: "700m (9)",
   },
   ...
   {
      name: "Vortigen Multi-Scope Energy Rifle",
      source: "Core",
      category: "weapon",
      weaponType: "Energy",
      damage: "20",
   ...
   {
      name: "Lance & Ferman ‘Deadeye’ Rifle",
      source: "Core",
      category: "weapon",
      weaponType: "Energy",
      damage: "15",
      ammo: "N/A",
      price: 5000000,
      notes: "+20 to Energy Weapons score.",
      rangeShort: "24m (5)",
      rangeMedium: "200m (6)",
      rangeLong: "700m (9)",
   },

   {
      ...
      ammo: "N/A",
      price: 28799000,
      notes: "+15 to Energy Weapons score.",
      rangeShort: "20m (5)",
      rangeMedium: "150m (6)",
      rangeLong: "500m (9)",
   },
   {
      name: "Prototype HV Arc Launcher",
      source: "Evolution",
      category: "weapon",
      weaponType: "Energy",
      damage: "Short: 20 / Medium: 15 / Long: 10",
      ammo: 3,
      price: 70000,
      notes: "Arcs.",
      rangeShort: "6m (3)",
...

   {
      ...
      ammo: 5,
      price: 500000,
      notes: "+1 Night Vision Scope. Penetration. Anti Vehicle.",
      rangeShort: "24m (6)",
      rangeMedium: "150m (7)",
      rangeLong: "700m (10)",
   },

   {
      ...
      ammo: 5,
      price: 10000000,
      notes: "+1 Night Vision Scope. Noise Suppressor. +2 to Assassination Difficulty.",
      rangeShort: "24m (6)",
      rangeMedium: "200m (7)",
      rangeLong: "800m (10)",
   },

   {
      ...
      ammo: 1,
      price: 50000000,
      notes: "+1 Scope. Bipod. Knockback 3. Armour Piercing (10). Anti Tank. Destroy Cover.",
      rangeShort: "32m (6) (Min 20m)",
      rangeMedium: "200m (7)",
      rangeLong: "800m (10)",
   },
   {
      ...
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Kinetic",
      damage: "2D10 + Burst",
      ammo: 10,
      price: 1000,
      notes: "Heavy Burst (6D10). Divide Fire. Destroy Cover.",
      rangeShort: "30m (5)",
      rangeMedium: "60m (8)",
      rangeLong: "180m (14)",
   },

   {
      ...
      ammo: 6,
      price: 7600000,
      notes: "Heavy Burst (8D10). Divide Fire. Destroy Cover.",
      rangeShort: "30m (5)",
      rangeMedium: "60m (8)",
      rangeLong: "180m (14)",
   },
   ...
   {
      name: "Lance & Ferman Gimballed Minigun",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Kinetic",
      damage: "2D10 + Burst",
      ammo: 10,
      price: 9000000,
      notes: "Heavy Burst (6D10). Divide Fire. Destroy Cover. +15 Heavy Weapons score.",
      rangeShort: "30m (5)",
      rangeMedium: "60m (8)",
      rangeLong: "180m (14)",
   },

   {
      ...
      ammo: 10,
      price: 42000000,
      notes: "Heavy Burst (10D10). Divide Fire. Destroy Cover. +5 Heavy Weapons score.",
      rangeShort: "40m (5)",
      rangeMedium: "80m (8)",
      rangeLong: "200m (14)",
   },
   {
      name: "Missile Launcher (Anti-Personnel)",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Explosive",
      damage: "Fatal: 50 / Injury: 20",
      ammo: 1,
      price: 200,
      notes: "Blast Radius: 10m Fatal, 24m Injury. Half damage vs shields.",
      rangeShort: "N/A (Min Range 26m)",
      rangeMedium: "200m (9)",
      rangeLong: "2km (12)",
   },

   {
      name: "Missile Launcher (Anti-Tank)",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Explosive",
      damage: "Fatal: 100 / Injury: 20",
      ammo: 1,
      price: 700,
      notes: "Blast Radius: 2m Fatal, 20m Injury. Half damage vs shields.",
      rangeShort: "N/A (Min Range 26m)",
      rangeMedium: "200m (9)",
      rangeLong: "2km (12)",
   },
   ...
   {
      name: "Missile Launcher (Anti-Aircraft)",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Explosive",
      damage: "Fatal: 120 / Injury: 20",
      ammo: 1,
      price: 2000,
      notes: "Blast Radius: 2m Fatal, 40m Injury. Half damage vs shields. Ignore Range hit number when attacking spacecraft.",
      rangeShort: "N/A (Min Range 26m)",
      rangeMedium: "2km (10)",
      rangeLong: "6km (13)",
   },
   ...
   {
      name: "Acane Model 5 Bazooka",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Explosive",
      damage: "Fatal: 60 / Injury: 20",
      ammo: 1,
      price: 97000,
      notes: "Blast Radius: 10m Fatal, 24m Injury. Half damage vs shields. +5 to Heavy Weapons score.",
      rangeShort: "N/A (Min Range 26m)",
      rangeMedium: "200m (9)",
      rangeLong: "2km (12)",
   },
   ...
   {
      name: "ODO 15 Light Anti-Tank Weapon",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Explosive",
      damage: "Fatal: 130 / Injury: 30",
      ammo: 1,
      price: 816000,
      notes: "Blast Radius: 2m Fatal, 20m Injury. Half damage vs shields.",
      rangeShort: "N/A (Min Range 26m)",
   ...
   {
      name: "XLS Omega Recoilless Rifle",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Explosive",
      damage: "Fatal: 60 / Injury: 30",
      ammo: 4,
      price: 23300000,
      notes: "Blast Radius: 10m Fatal, 24m Injury. Half damage vs shields. +15 to Heavy Weapons score.",
      rangeShort: "N/A (Min Range 26m)",
      rangeMedium: "200m (9)",
      rangeLong: "2km (12)",
   },
   {
      ...
      source: "Core",
      category: "weapon",
      weaponType: "Heavy Energy",
      damage: "2D10",
      ammo: 5,
      price: 100000,
      notes: "Burst (4D10). Cone. Ignite on 8+ To Hit.",
      rangeShort: "8m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "30m (12)",
   },

   {
      ...
      ammo: 5,
      price: 20000,
      notes: "Cone. Immobilize. Difficulty 10.",
      rangeShort: "8m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "30m (12)",
   },

   {
      ...
      ammo: 5,
      price: 10000000,
      notes: "Burst (4D10). Cone. Freeze on 8+ To Hit.",
      rangeShort: "8m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "30m (12)",
   },
   ...
   {
      name: "Miasma Tox-Thrower",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy Toxin",
      damage: "4D10",
      ammo: 5,
      price: 25000000,
      notes: "Burst (4D10). Cone. Toxin on 8+ To Hit.",
      rangeShort: "8m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "30m (12)",
   },

   {
      ...
      ammo: 5,
      price: 45000000,
      notes: "Burst (4D10). Cone. Destroy Cover. Ignite on 6+ To Hit.",
      rangeShort: "8m (3)",
      rangeMedium: "12m (7)",
      rangeLong: "30m (12)",
   },
   {
      ...
      ammo: "N/A",
      price: 10000000,
      notes: "Burst (20). Divide Fire. Ignite on 8+ To Hit. +10 damage vs organic Targets. -10 damage vs mechanical Targets (minimum 0).",
      rangeShort: "12m (4)",
      rangeMedium: "70m (7)",
      rangeLong: "200m (10)",
   },

   {
      ...
      ammo: "N/A",
      price: 10000000,
      notes: "Burst (20). Divide Fire. Disable on 8+ to Hit. +10 damage vs mechanical Targets. -10 damage vs organic Targets (minimum 0).",
      rangeShort: "12m (4)",
      rangeMedium: "70m (7)",
      rangeLong: "200m (10)",
   },

   {
      ...
      ammo: 3,
      price: 10000000,
      notes: "Burst (20). Divide Fire. Destroy Cover. Cooling Cells.",
      rangeShort: "12m (4)",
      rangeMedium: "70m (7)",
      rangeLong: "200m (10)",
   },
   {
      ...
      category: "weapon",
      weaponType: "Heavy, Energy",
      damage: "Fatal: 100 / Injury: 40",
      ammo: 4,
      price: 4000,
      notes: "Blast Radius: 12m Fatal, 34m Injury. Firer knocked over unless weapon is tripod mounted.",
      rangeShort: "N/A (Min Range 36m)",
      rangeMedium: "500m (9)",
      rangeLong: "3km (12)",
   },

   {
      name: "Altair JP60 Accelerator",
      source: "Core",
      category: "weapon",
      weaponType: "Heavy, Energy",
      damage: "Fatal: 140 / Injury: 50",
      ammo: 2,
      price: 13500000,
      notes: "Blast Radius: 12m Fatal, 34m Injury. Firer knocked over unless weapon is tripod mounted.",
      rangeShort: "N/A (Min Range 36m)",
...
export async function createRangedWeaponItems() {
   for (const weapon of rangedWeapons) {
      const exists = game.items.some(
         (item) =>
            item.type === "equipment" &&
      ...
      await Item.create({
         ...
         system: {
            ...
            ammo: weapon.ammo,
            rangeShort: weapon.rangeShort,
            rangeMedium: weapon.rangeMedium,
